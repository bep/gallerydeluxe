...
export function Pig(imageData, options) {
	...
	this.settings = {
		...
		getImageSize: function (lastWindowWidth) {
			// Pick a higher-density bucket on retina screens so thumbnails don't
			// get upscaled (blurry) on phones/tablets with devicePixelRatio > 1.
			// Buckets generated by create-thumbs.html: 100, 250, 500.
